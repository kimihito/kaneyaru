<?php
  ...
  // アプリケーションのアドレス
  $app_addr = 'http://localhost:8888/kaneyaru/form.php';
  ...
  function main() {
    ...
    if (empty($ret['client'])) {
      ...
      header('Location: http://localhost:8888/kaneyaru/form.php');
